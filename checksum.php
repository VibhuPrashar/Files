...
//validation step to check whether the method recied is either get method or post method
if(strcasecmp($_SERVER['REQUEST_METHOD'],'POST')!=0)
{
	throw new Exception('Request moethod must be post');
}
...
{
	throw new Exception('Recieved Data is not in the json format');
}
